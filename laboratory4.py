...
pipe_expander.markdown(
    ...
    \n4. Обучение модели:
    \nДанный процесс запускается с помощью встроенной функций fit из библиотеки [tensorflow](https://www.tensorflow.org/). Данная функция получает на вход обучающую выборку, а на выход так называемые "метки" (правильные ответы) для этой выборки. Далее происходит процесс обучения и корректировки нейронной модели;
    \n5. Проверка точности:
