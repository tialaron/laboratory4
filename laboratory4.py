...
neiro_expander.markdown(
    ...
    за счёт входных и выходных связей ([пример](/pictures/fully_connected_NN.png)). Различают внешние слои - входной и выходной, и внутренние, находящиеся между ними.
    ...
    (ослабления) влияния связи - весовой коэффициент, или вес. На выходе нейрона действует [функция активации](pictures/activation_functions.png), за счёт нелинейностей 
