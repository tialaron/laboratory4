...
st.write('В данной работе Вам предстоит проверить насколько хорошо обучена нейронная сеть распознавать рукописные цифры. ')
st.write('Это может пригодиться для создания программ прочтения и перевода в печатный текст рукописей или рецептов врача.')
