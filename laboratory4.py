...
neiro_expander = st.expander("Краткое описание искусственной нейронной сети и ее работы.")
neiro_expander.markdown(
    """
    \nИскусственная нейронная сеть - это математическая модель настоящей нейронной сети, 
    ...
    за счёт входных и выходных связей ([пример](/app/laboratory4/pictures/fully_connected_NN.png)). Различают внешние слои - входной и выходной, и внутренние, находящиеся между ними.
    ...
    (ослабления) влияния связи - весовой коэффициент, или вес. На выходе нейрона действует [функция активации](/app/laboratory4/pictures/activation_functions.png), за счёт нелинейностей 
